    ...
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden">
      <div class="grid md:grid-cols-2">
        ...
        <div class="p-12">
          ...
          <p class="text-gray-600 mb-8">Akkauntingizga kiring</p>
        ...
        <div class="bg-gradient-to-br from-blue-600 to-purple-600 p-12 text-white flex flex-col justify-center">
          <h2 class="text-3xl font-bold mb-6">Karyerangizni rivojlantiring</h2>
          <ul class="space-y-4">
            <li v-for="(feature, index) in features" :key="index" class="flex items-start gap-3">
              ...
              <div>
                ...
                <div class="text-sm text-blue-100">{{ feature.description }}</div>
              </div>
            </li>
          </ul>
        </div>
...
const features = ref([
  {
    title: "Real vaqtda o'sish tracking",
    description: "Dashboard va statistika bilan"
  },
  {
    title: "Mock intervyu va testlar",
    description: "Suhbatlarga tayyorgarlik"
  },
  {
    title: "Shaxsiy roadmap",
    description: "Keyingi darajaga o'tish rejasi"
  },
  {
    title: "Vakansiyalar",
    description: "Sizga mos ishlar avtomatik"
  }
]);
...
const handleSubmit = () => {
  ...
  // Navigate to dashboard (Vue Router kerak)
